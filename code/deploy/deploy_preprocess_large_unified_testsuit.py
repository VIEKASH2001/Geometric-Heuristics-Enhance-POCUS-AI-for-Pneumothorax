        ...
        with torch.no_grad():
            ...
            for idx in range(idx_count):
                ...
                if temp_sampling_method == "equi_temp_sampling":
                    ...
                    clip_frame_ids = np.arange(start_frame, len(video_frames), clip_stride).astype(int)
                    ...
                    clip_frame_ids = np.arange(start_frame, start_frame+(clip_width*clip_stride), clip_stride).astype(int)
